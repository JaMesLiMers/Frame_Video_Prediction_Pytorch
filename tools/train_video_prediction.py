...
parser.add_argument('-c', '--cfg', default='./tools/train_config.json', type=str, required=False, help='training config file path')

args = parser.parse_args()

# 初始化logger
global_logger = init_log('global', level=logging.INFO)
add_file_handler("global", './logs/ex_1.log', level=logging.DEBUG)
